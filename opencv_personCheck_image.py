...
while True:
    ...
    cv2.rectangle(img=frame, pt1=(10, 15), pt2=(420, 35), color=(0,0,0), thickness=-1)
    
    #영상에 글자를 더해주는 역할을 함
    frame = Image.fromarray(frame)
    draw = ImageDraw.Draw(frame)
    # xy는 텍스트 시작위치임, 
    draw.text(xy=(10, 15),  text="DreamQ- 식당 혼잡도 "+nowDatetime, font=font, fill=(255, 255, 255))
    ...
    if cv2.waitKey(0) & 0xFF == ord('q'): #q입력시 무한루프 종료
        break
